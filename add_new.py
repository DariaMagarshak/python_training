...
class add_new(unittest.TestCase):
    ...
    def test_add_new(self):
        ...
        self.create_contact(wd, Contact(firstname="Иван", middlename="Васильевич", lastname="Котейкин", nickname="IVA_cat", company="Производство блинчиков corp",
    ...
    def create_contact(self, wd, contact):
        ...
        wd.find_element_by_css_selector("select[name=\"aday\"] > option[value=\"12\"]").click()
